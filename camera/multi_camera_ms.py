...
BRIGHTNESS = 0
# save_dir = ''
save_dir = '/home/vision/바탕화면/alc/new_camera/new_pog'
# save_dir = '/home/vision/바탕화면/error_rhkrrlwn'

save_dir_pullimg = '/home/vision/바탕화면/new_beat/full_image'
...
######################################################################################################################
    ...
    # box 변경 ( '[' : - 변경,   ']' : + 변경)
        ...
        if MODE == 'a':
            cv2.imwrite(save_dir_pullimg + "/" + today + "_left.jpg", img0_pi)
            cv2.imwrite(save_dir_pullimg + "/" + today + "_right.jpg", img00_pi)
